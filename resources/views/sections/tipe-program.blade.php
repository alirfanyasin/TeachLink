<section id="tipe-program" class="mt-32 mb-32">
  <header class="text-center mb-10">
    <h2 class="text-[#0065DB] font-bold text-3xl mb-3">Belajar kapan aja, dimana aja!</h2>
    <p class="text-[#3F3F3F] text-xl">jarak dan waktu bukan kendala. <br>
      Pilih metode yang kamu suka buat belajar bareng mentor kamu!
    </p>
  </header>

  <div class="grid grid-cols-2 gap-10">

    <div class="text-center relative overflow-hidden rounded-3xl">
      <img src="{{ asset('assets/img/card-1.png') }}" class="w-full" alt="Non Akademik">
      <div class="absolute bottom-0 text-white text-left mx-10 mb-10">
    ...
    <div class="text-center relative overflow-hidden rounded-3xl">
      <img src="{{ asset('assets/img/card-2.png') }}" class="w-full" alt="Non Akademik">
      <div class="absolute bottom-0 text-white text-left mx-10 mb-10">
