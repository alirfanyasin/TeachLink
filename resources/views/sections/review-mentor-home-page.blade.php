<section class="mb-52 mt-32">
  <header class="text-left mb-10 flex items-center justify-between">
    ...
    <div class="flex">
      <div class="p-2 rounded-full bg-[#EFEFEF] hover:cursor-pointer mr-2 hover:bg-[#0065DB]">
        <img src="{{ asset('assets/icon/arrow-left.svg') }}" alt="">
      </div>
      <div class="p-2 rounded-full bg-[#EFEFEF] hover:cursor-pointer hover:bg-[#0065DB]">
  ...
  <div class="grid grid-cols-2 gap-10">
    <div class="card rounded-2xl relative">
